...
const HeroSection = ({ names, date }: HeroSectionProps) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-paper">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <button
            className="inline-flex items-center gap-3 px-6 py-2.5 bg-transparent border border-muted-foreground/30 text-muted-foreground font-body text-xs tracking-widest uppercase rounded-full hover:border-muted-foreground/50 hover:text-foreground transition-all duration-300"
          >
